...
import ru.marat.springcourse.repositories.PeopleRepository;
...
public class PeopleService {
    ...
    public Person findOne(int id) {
        Optional<Person> personToFind = peopleRepository.findById(id);
        return personToFind.orElse(null);
    }
